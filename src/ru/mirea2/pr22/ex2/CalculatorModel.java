...
import ru.mirea2.pr22.ex1.DivisionByZeroException;
import ru.mirea2.pr22.ex1.EmptyStackException;
...
public class CalculatorModel {
    ...
    public void fromPolandToNormal() throws ru.mirea2.pr22.ex1.EmptyStackException, ru.mirea2.pr22.ex1.DivisionByZeroException, EmptyStringException, DoubleParseException {
        Double result = 0d;
    ...
    private Double operationResult(Double firstNum, Double secondNum, String operand) throws ru.mirea2.pr22.ex1.DivisionByZeroException {
